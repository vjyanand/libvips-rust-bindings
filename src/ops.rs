...
pub struct RawloadOptions {
    /// offset: `u32` -> Offset in bytes from start of file
...
pub fn rawload_with_opts(
    ...
    unsafe {
        ...
        let offset_in: u32 = rawload_options.offset;
...
pub fn radload_buffer(buffer: &[u8]) -> Result<VipsImage> {
    unsafe {
        ...
        let vips_op_response =
            bindings::vips_radload_buffer(buffer_in, u32, &mut out_out, NULL);
        utils::result(
            vips_op_response,
            VipsImage { ctx: out_out },
...
pub fn svgload_buffer(buffer: &[u8]) -> Result<VipsImage> {
    unsafe {
        ...
        let vips_op_response =
            bindings::vips_svgload_buffer(buffer_in, u32, &mut out_out, NULL);
        utils::result(
            vips_op_response,
            VipsImage { ctx: out_out },
...
pub fn gifload_buffer(buffer: &[u8]) -> Result<VipsImage> {
    unsafe {
        ...
        let vips_op_response =
            bindings::vips_gifload_buffer(buffer_in, u32, &mut out_out, NULL);
        utils::result(
            vips_op_response,
            VipsImage { ctx: out_out },
...
pub fn pngload_buffer(buffer: &[u8]) -> Result<VipsImage> {
    unsafe {
        ...
        let vips_op_response =
            bindings::vips_pngload_buffer(buffer_in, u32, &mut out_out, NULL);
        utils::result(
            vips_op_response,
            VipsImage { ctx: out_out },
...
pub fn jpegload_buffer(buffer: &[u8]) -> Result<VipsImage> {
    unsafe {
        ...
        let vips_op_response =
            bindings::vips_jpegload_buffer(buffer_in, u32, &mut out_out, NULL);
        utils::result(
            vips_op_response,
            VipsImage { ctx: out_out },
...
pub fn webpload_buffer(buffer: &[u8]) -> Result<VipsImage> {
    unsafe {
        ...
        let vips_op_response =
            bindings::vips_webpload_buffer(buffer_in, u32, &mut out_out, NULL);
        utils::result(
            vips_op_response,
            VipsImage { ctx: out_out },
...
pub fn tiffload_buffer(buffer: &[u8]) -> Result<VipsImage> {
    unsafe {
        ...
        let vips_op_response =
            bindings::vips_tiffload_buffer(buffer_in, u32, &mut out_out, NULL);
        utils::result(
            vips_op_response,
            VipsImage { ctx: out_out },
...
pub fn heifload_buffer(buffer: &[u8]) -> Result<VipsImage> {
    unsafe {
        ...
        let vips_op_response =
            bindings::vips_heifload_buffer(buffer_in, u32, &mut out_out, NULL);
        utils::result(
            vips_op_response,
            VipsImage { ctx: out_out },
